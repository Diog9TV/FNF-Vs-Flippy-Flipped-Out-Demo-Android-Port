function onCreate()
	...
	-- background shit
	makeLuaSprite('sky', 'phase1/sky', -600, -225);
	setScrollFactor('sky', 0.5, 0.5);

	makeLuaSprite('backtrees', 'phase1/backtrees', -625, -200);
	setScrollFactor('backtrees', 0.7, 0.7);
	
	makeLuaSprite('trees', 'phase1/trees', -625, -225);
	setScrollFactor('trees', 0.8, 0.8);

	makeLuaSprite('ground', 'phase1/ground', -700, -150);
	...
	makeLuaSprite('table', 'phase1/table', -850, -200);
